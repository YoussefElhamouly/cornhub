...
const getLanguageColor = (language: keyof typeof languageColors) => {
...
interface projectCardProps {
  ...
  description?: string;
  visibility?: string;
  language?: keyof typeof languageColors | string;
  stars?: number;
  icon?: string;
  path: string;
}
...
const ProjectCard = ({
  ...
  const languageColor = getLanguageColor(
    language as keyof typeof languageColors,
  );
    ...
    <div className={styles.project_link}>
      <div className={styles.project_header}>
        <div className={styles.project_icon_name}>
          ...
          <Link className={styles.project_name_link} href={path}>
