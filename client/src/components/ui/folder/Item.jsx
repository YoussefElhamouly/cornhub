...
const FOLDER_CLOSED = (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="3 5 18 14">
    <path
      d="M3 6.5C3 5.67 3.67 5 4.5 5H9.17C9.7 5 10.2 5.21 10.56 5.59L11.83 7H19.5C20.33 7 21 7.67 21 8.5V17.5C21 18.33 20.33 19 19.5 19H4.5C3.67 19 3 18.33 3 17.5V6.5Z"
      fill="currentColor"
    />
  </svg>
);
...
const FOLDER_OPEN = (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="2.5 5 19 14.5">
    <path
...
const Item = ({ name, type = "folder", isExpanded = false }) => {
