...
const Overview = () => {
  ...
  const contributionDataByYear: Record<string, Record<string, number>> = {
    "2026": {
      "2026-01-01": 1,
      "2026-01-02": 2,
      "2026-01-03": 3,
  ...
  const handleDayClick = (date: Date, value: number) => {
